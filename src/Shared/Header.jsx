        ...
        <nav className="flex flex-wrap items-center">
          ...
          <div className="navbar mx-auto">
            <ul className="navbar-nav flex flex-wrap items-center gap-11">
              ...
              <li className="nav-items">
                <Link to={"/features"} className="nav-link text-base font-semibold text-white capitalize">
                  Features
                </Link>
              </li>

              <li className="nav-items">
                <Link to={"/pricing"} className="nav-link text-base font-semibold text-white capitalize">
                  Pricing
                </Link>
              </li>

              <li className="nav-items">
                <Link to={"/contact"} className="nav-link text-base font-semibold text-white capitalize">
                  Contact
                </Link>
              </li>
