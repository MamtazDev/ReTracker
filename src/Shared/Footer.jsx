            ...
            <div className="flex items-center gap-3">
              {socialIcons.length > 0 &&
                socialIcons.map((data, index) => (
                  <div
                    key={index}
                    className="border border-slate-200 text-primary text-xl  hover:text-white rounded-full h-10 w-10 flex justify-center items-center transition duration-600 ease-in-out hover:bg-primary"
                  >
