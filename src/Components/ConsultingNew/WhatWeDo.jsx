...
const WhatWeDo = () => {
  return (
    <section className="whatWeDo pt-12 md:pt-24 pb-8 md:pb-16 overflow-hidden">
      <div className="container max-w-[1030px] px-5">
        <div className="section_title mb-8">
          <h2 className="text-5xl font-semibold text-slate-950 text-center">
        ...
        {whatWeDoCard.map((cardData) => (
          <div
            className="whatwedo_card p-10 bg-white shadow-lg rounded-3xl mb-8"
            key={cardData.id}
              ...
              <div className="col-span-8">
                <div className="card_content">
                  ...
                  <p className="text-base font-normal text-secondary flex items-start gap-2 ">
                    <img className="pt-2" src={ringCircleImg} alt="ring" />{" "}
