...
const Banner = () => {
    return (
        <section className="home_banner_section pt-[75px] pb-16 md:pt-[104px] px-16">
                ...
                <div className="col-span-6">
                    <div className="banner_content">
                        <div className="section_title pb-3 md:pb-5">
                            ...
                            <h4 className='text-5xl font-bold text-primary mb-5'>
                                $ 299.00
                            </h4>
                            <p className='text-lg font-normal text-slate-700 mb-12'>
                ...
                <div className="col-span-6">
                    <div className="consultancy_img flex justify-center">
                        <span className='flex-shrink-0'>
                            <img className='w-full' src={ConsultancyImg} alt="consultancy-banner-img" />
                        </span>
                    </div>
                </div>
