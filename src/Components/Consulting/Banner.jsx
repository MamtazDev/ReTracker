...
const Banner = () => {
    return (
        <section className="home_banner_section pt-[75px] pb-16 md:pt-[104px] md:px-16 overflow-x-hidden">
                ...
                <div className="col-span-12 md:col-span-6">
                    <div className="banner_content">
                        <div className="section_title pb-3 md:pb-5" >
                            <h2 className="text-2xl md:text-6xl font-bold mb-1" data-aos="fade-up" data-aos-duration="500">
                                RE Tracker Consulting
                            </h2>
                            <h4 className='text-2xl md:text-5xl font-bold text-primary mb-5' data-aos="fade-up" data-aos-duration="1000">
                                $ 299.00
                            </h4>
                            <p className='text-sm md:text-lg font-normal text-slate-700 mb-12' data-aos="fade-up" data-aos-duration="1500">
